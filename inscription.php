    ...
    if ($_POST['login'] && $_POST['password'] && $_POST['confirmpassword']) {
        ...
        if ($pass == $confirmpass) {
            ...
            if ($log_ok == true) {
                ...
                $erreur = '<p style = "color:red; font-weight:bold ">Le nom du login est déja utilisé</p>';
            }
        } else {
            $erreur = '<p style = "color:red; font-weight:bold ">les mots de passes ne sont pas identique</p>';
        }
    } else {
        $erreur = '<p style = "color:red; font-weight:bold ">veuillez remplir tous les champs</p>';
    }
}
